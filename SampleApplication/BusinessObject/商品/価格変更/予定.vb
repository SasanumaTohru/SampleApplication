Namespace BusinessObject.商品.価格変更
    ...
    Public Class 予定
        ...
        Private m_変更前価格 As PrimitiveObject.金額
        ...
        Public Sub New(商品ID As 商品ID,
                       価格区分 As 価格区分リスト, 変更前価格 As PrimitiveObject.金額, 変更後価格 As PrimitiveObject.金額,
                       適用開始日 As PrimitiveObject.日付)
            価格区分が正しい(価格区分)
            適用開始日が明日以降である(適用開始日)
            m_商品ID = 商品ID
            m_価格区分 = 価格区分
            m_変更前価格 = 変更前価格     '変更前価格は、必ずしも現行価格とは限らない。
            m_変更後価格 = 変更後価格
            m_適用開始日 = 適用開始日
        End Sub
        ...
        Public ReadOnly Property 変更前価格 As PrimitiveObject.金額
            Get
                Return m_変更前価格
            End Get
        End Property
